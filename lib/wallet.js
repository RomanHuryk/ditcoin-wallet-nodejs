...
// helper function to build options for ditcoin's transfer
...
class Wallet {
    constructor(hostname = '127.0.0.1', port = 19092, username, password = '') {
...
Wallet.prototype.createWallet = function (filename = 'dit_wallet', password = 'ditcoin', language = 'English') {
    let body = {
...
// Opens a new wallet
Wallet.prototype.openWallet = function (filename = 'dit_wallet', password = 'ditcoin') {
    let body = {
        method: 'open_wallet',
        params: {
            filename: filename,
...
// stop the current ditcoin-wallet-rpc process
